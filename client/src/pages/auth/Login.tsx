      ...
      <div className='relative w-full max-w-md overflow-hidden rounded-3xl border border-white/20 bg-white/10 p-8 shadow-2xl backdrop-blur-lg'>
        ...
        <div className='relative z-10'>
          <div className='mb-8 text-center'>
            <h1 className='mb-2 text-3xl font-bold tracking-tight text-white'>Chào mừng trở lại</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
            ...
            <button
              ...
              className='w-full transform rounded-xl bg-white py-3.5 font-semibold text-red-600 shadow-lg transition-all hover:bg-white/90 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-70'
            >
